...
const Register = () => {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      const data = await sendRegisterOtp(formData);
  ...
  const verifyOtpHandler = async () => {
    ...
    try {
      await verifyRegisterOtp({ email: formData.email, otp: formData.otp });
          ...
          <>
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                className="shadow-sm shadow-zinc-300 px-4 py-2 rounded-md outline-none focus:ring-2 focus:ring-blue-400"
                maxLength={30}
              />
          ...
          <>
            ...
            {timer === 0 && (
              <button
                ...
                className="text-blue-900 underline text-sm cursor-pointer"
              >
                Resend OTP
              </button>
            )}
